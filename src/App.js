...
function App() {
  return (
    <>
    <Menu />
    <section className="top-hero-section lg:h-screen lg:w-full  lg:grid lg:grid-cols-2 sm:no-grid  sm:grid-cols-1 gap-6 sm:gap-2 bg-gradient-to-t from-stone-200 to-white">

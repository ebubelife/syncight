...
function App() {
  return (
    ...
    <div className=" sm:pl-1  lg:mr-20 lg:ml-20  sm:pt-2 sm:pxc-3">
      <h1 className="sm:ml-5 sm:w-full lg:text-justify sm:ml-4 sm:text-center font-bold sm:text-justify text-4xl mt-20 text-yellow-600 ">We summarise stuff</h1>

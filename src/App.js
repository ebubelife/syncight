...
function App() {
  return (
    <>
    <Menu />
    <section className="top-hero-section lg:h-screen lg:w-full sm:px-3  lg:grid lg:grid-cols-2 sm:no-grid  sm:grid-cols-1 gap-6 sm:gap-2 bg-gradient-to-t from-stone-200 to-white">
    <div className=" sm:pl-1 lg:w-full lg:mr-20 lg:ml-20 sm:mx-10 sm:pt-2 sm:px-48">
